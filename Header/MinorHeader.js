...
<View style={[globalStyles.headerHeaderFile,{backgroundColor:theme.backgroundColor}]}>
      ...
      size={28} onPress={goBackPage} style={[globalStyles.iconHeaderFile,{color:theme.color}]} />

        <Text style={[globalStyles.headerTextHeaderFile1,{color:theme.color}]}>{title}</Text>
