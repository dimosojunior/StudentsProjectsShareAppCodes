...
const downloadFromAPI = async () => {
  ...
  return (
   ...
   <MinorHeader title="Read Project"/>
    ...
    <ScrollView>
      ...
      <View style={[globalStyles.userInfoSection, {backgroundColor:theme.backgroundColor}]}>
        <View style={[globalStyles.ImageAndTitleContainer, {backgroundColor:theme.backgroundColor}]}
          ...
          <Image 
            ...
            source={{uri: EndPoint + '/' + ProjectImage}}
          ...
          <View style={globalStyles.TitleArticleContainer}>
            <Text style={[globalStyles.ArticleMainTitleText, {color:theme.color}]}>{ProjectName}</Text>
      ...
      <View style={[globalStyles.userInfoSection, {backgroundColor:theme.backgroundColor}]}>
        <View style={globalStyles.row}>
          ...
          <Text style={[{marginLeft: 20}, {color:theme.color}]}>Student Name: {StudentName}</Text>
        </View>
      
        <View style={globalStyles.row}>
          <FontAwesome name="book" style={[globalStyles.icons, {color:theme.color}]} size={20}/>
          <Text style={[{marginLeft: 20}, {color:theme.color}]}>Year: {Year}</Text>
        </View>
       
       {StudentEmail && (
        <View style={globalStyles.row}>
          <MaterialIcons name="email" style={[globalStyles.icons, {color:theme.color}]} size={20}/>
          <Text style={[{marginLeft: 20}, {color:theme.color}]}>Student Email: {StudentEmail}</Text>
        </View>)}

         <View style={globalStyles.row}>
          <MaterialIcons name="phone" style={[globalStyles.icons, {color:theme.color}]} size={20}/>
          <Text style={[{marginLeft: 20}, {color:theme.color}]}>Phone Number: {StudentPhoneNumber}</Text>
        </View>
       ...
       {pdf && (
         ...
         <View style={globalStyles.row}>
          ...
          >
          <Text style={[{marginLeft: 20}, {color:theme.color}]}>Download Project file</Text>
        </TouchableOpacity>
        </View>
        )}
...
/>
      ...
      <View style={[globalStyles.menuWrapper, {backgroundColor:theme.backgroundColor}]}>
       ...
       {StudentPhoneNumber && (
        <TouchableOpacity onPress={() => { Linking.openURL(`whatsapp://send?phone=${StudentPhoneNumber}&text=${message}`)}}>
          <View style={[globalStyles.menuItem, {backgroundColor:theme.backgroundColor}]}>
      ...
      {StudentPhoneNumber && (
        <TouchableOpacity  onPress={() => sendTextMessage(StudentPhoneNumber, message)}>
          <View style={[globalStyles.menuItem, {backgroundColor:theme.backgroundColor}]}>
        ...
        {StudentEmail && (
         <TouchableOpacity onPress={() => {  Linking.openURL(`mailto:${StudentEmail}?subject=Hello ${StudentName}&body=${message}`)}}>
          <View style={[globalStyles.menuItem, {backgroundColor:theme.backgroundColor}]}>
           ...
           {StudentPhoneNumber && (
         <TouchableOpacity onPress={() => {   Linking.openURL(`tel:${StudentPhoneNumber}`)}}>
          <View style={[globalStyles.menuItem, {backgroundColor:theme.backgroundColor}]}>
